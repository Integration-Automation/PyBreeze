...
pybreeze_traditional_chinese_word_dict = {
    ...
    "install_menu_automation_file": "安裝 FileAutomation",
    ...
    "test_pioneer_run_yaml": "執行 TestPioneer YAML",
    ...
    "extend_tools_menu_skill_prompt_send_tab_action": "Skill 提示詞傳送分頁",
    ...
    "diagram_editor_filter_svg": "SVG 圖片 (*.svg)",
    "diagram_editor_filter_images": "圖片 ({patterns})",
    "diagram_editor_filter_all": "所有檔案 (*)",
