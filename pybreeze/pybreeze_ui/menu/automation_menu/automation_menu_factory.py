...
def safe_create_project(import_name: str) -> Callable:
    ...
    def _create():
        try:
            package = importlib.import_module(import_name)  # nosemgrep: non-literal-import — plugin registry uses a curated whitelist of automation packages (build_process)
